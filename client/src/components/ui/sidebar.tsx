    ...
    <Tooltip>
      <TooltipTrigger asChild>
        <Button
          ...
          size="icon"
          className={cn("size-8 mx-3 my-2", className)}
          onClick={(event) => {
            onClick?.(event);
            toggleSidebar();
          }}
      ...
      <TooltipContent>
        <div className="flex items-center text-md text-center gap-1">
          <Command size={12} />+<b>{SIDEBAR_KEYBOARD_SHORTCUT.toUpperCase()}</b>
        </div>
      </TooltipContent>
    </Tooltip>
  );
